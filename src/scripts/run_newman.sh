...
newman run https://api.getpostman.com/collections/20634702-00d96313-db26-4c47-bd1c-15948f77681a?apikey=$POSTMAN_API_KEY --environment https://api.getpostman.com/environments/20634702-ce70ac3d-efdc-48ad-a601-0a47b7ce02b2?apikey=$POSTMAN_API_KEY --reporters testrail
 --verbose